     ...
     $('#create').on('click', function(){
           ...
           // datos de sesion del usuario
            ...
            fecha_nacimiento = document.getElementById('fecha_nacimiento');
             ...
             if (pass1.value == "" ||  pass2.value == "" ||  apellido.value == "" ||  nombre.value == "" ||  documento.value == "" ||  cuil.value == "" ||  user.value == "" ||  sexo.value == "" ||  fecha_nacimiento.value == "") {
            ...
            // Verificamos si las constraseñas no coinciden 
                ...
                $.ajax({
                    data: data,
                    url: '/storepersonauser/organismouser',
                    type: "POST",
                    dataType: 'json',
