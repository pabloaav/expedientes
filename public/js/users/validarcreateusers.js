    ...
    $.ajaxSetup({
     ...
     $('#create').on('click', function(){
            ...
            organismo_id = document.getElementById('organismo_id');
             ...
             if (pass1.value == "" ||  pass2.value == "" ||  apellido.value == "" ||  nombre.value == "" ||  documento.value == "" ||  cuil.value == "" ||  telefono.value == "" ||  direccion.value == "" ||  localidad.value == "" ||  user.value == ""  ||  organismo_id.value == "") {
                $("#errorVacio").fadeIn()
