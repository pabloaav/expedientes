        ...
        <div class="col-md-12 portlets ui-sortable">
            <div class="widget">
                ...
                <div class="widget-content">
                    <form method="POST" action="{{url("organismos/{$organismo->id}/tiposvinculo/store")}}">
                        {!!csrf_field()!!}
                                ...
                                <div class="form-group">
                                    <div class="col-xs-12">
                                        <div class="row">
                                            ...
                                            <div class="col-xs-4">
                                                <label for="input-text" class="control-label" style="padding-top: 5px;"> Activo</label>
                                                <div class="col-xs-2" style="margin-top: 5px;"><input type="checkbox" class="ios-switch ios-switch-success ios-switch-sm" name="activo" id="activo"
                                                    checked /></div>
                                            </div>
                                            ...
                                            <div class="col-xs-4">
                                                ...
                                                <div class="col-xs-2" style="margin-top: 5px;"><input type="checkbox" class="ios-switch ios-switch-success ios-switch-sm" name="titular" id="titular"/></div>
                                            </div>
                                            @endif
                                        </div>
                                    </div>
