...
.mostrar {
  ...
  <div class="content">
        ...
        <div class="page-heading">
			<h1><a href="/users"><i class='icon icon-left-circled'></i>{{ $title }}</a></h1>
        </div>
				...
				<div class="col-sm-12 portlets">
				  <div class="widget">
					...
					<div class="alert alert-info">
						<center>Ingrese los datos de la persona</center>
					</div>
							...
							<div class="col-sm-12">
							  ...
							  <div class="row">
								<div class="col-xs-6">
								  ...
								  name="apellido" placeholder="Apellido" required autofocus>
								</div>
								<div class="col-lg-6">
							  ...
							  <div class="row">
								...
								<div class="col-lg-6"> 
									...
									<label>
									  <label>
									  <input id="sexo" type="radio" name="sexo" value="F">
									  Femenino</label>
								  </div>
							  ...
							  <div class="row">
								<div class="col-lg-6">
								  ...
								  <div class="col-lg-6">
									...
									<input id="fecha_nacimiento" type="date" class="form-control" name="fecha_nacimiento"  required autofocus>
								</div>
							  </div>
							  <br> 
							  <hr>
								...
								<div class="widget">
									...
									<div class="widget-content padding">
										<div class="form-group">
                                           ...
                                           <div class="col-lg-6">
											<label for="exampleInputEmail1">Seleccionar organismo</label>
											<select name="organismo_id" id="organismo_id" class="form-control" id="select-id">
...
<script src="/js/users/storepersonusers.js"> </script>
@endsection
@endsection
