            ...
            <div class="col-sm-12 portlets">
                <div class="widget">
                    <div class="widget-header ">
                        <h2><strong>Consultar Tipo de Documento</strong> {{ getDominioApi() }}</h2>
                        <div class="additional-btn">
                        </div>
                    </div>
                    <div class="widget-content padding">
                        <p><b>POST</b> /tipo-documento</p>

                        <p>Permite consultar un tipo de documento especifico asociado a un Organismo a travéz de la API RESTful de DOCO.</p>
                        ...
                        <div class="table-responsive" style="background-color: #f0f0f0;">
                            <table data-sortable class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>codigo</td>
                                        <td>código de un tipo de documento</td>
                                        <td>SI</td>
                                        <td>No se aceptan campos vacios</td>
                                        <td>"1222"</td>
                                    </tr>
                                </tbody>
                            </table>
