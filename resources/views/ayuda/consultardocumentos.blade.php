            ...
            <div class="col-sm-12 portlets">
                <div class="widget">
                    <div class="widget-header ">
                        <h2><strong>Consultar Documentos</strong> {{ getDominioApi() }}</h2>
                        <div class="additional-btn">
                        </div>
                    </div>
                    <div class="widget-content padding">
                        <p><b>POST</b> /documentos</p>

                        <p>Permite consultar documentos que estén en un rango de fechas determinado a travéz de la API RESTful de DOCO.</p>
