            ...
            <div class="col-sm-12 portlets">
                <div class="widget">
                    <div class="widget-header ">
                        <h2><strong>Consultar el Sector y Estado actual de un documento</strong> {{ getDominioApi() }}</h2>
                        <div class="additional-btn">
                        </div>
                    </div>
                    <div class="widget-content padding">
                        <p><b>POST</b> /sector-actual-documento</p>

                        <p>Permite consultar el sector y estado actual de un documento a travéz de la API RESTful de DOCO.</p>
                            ...
                            <table data-sortable class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>indica si el documento tiene usuario asignado</td>
                                    </tr>
                                    <tr>
                                            ...
                                            <pre><code class="html">
{
    "data": [
        {
            "id": 2125,
            "num_documento": "115606",
            "extracto": "viatico",
            "tipo_documento": "Viaticos",
            "fecha_creacion": "2022-10-28 12:43:06",
            "estado": "pasado",
            "sector_actual": "Dirección de RRHH",
            "usuario_actual": true,
            "fecha_ingreso_sector": "2022-11-04 09:11:15"
        }
    ],
    "status": true,
    "code": 200,
