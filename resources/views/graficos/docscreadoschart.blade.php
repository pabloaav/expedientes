        ...
        <div class="col-sm-12 portlets">
            <div class="widget">
                <div class="widget-header ">
                    <h2><strong>Reportes de Documentos</strong></h2>
                ...
                <div class="widget-content" style="overflow: auto; padding: 30px;">
                    ...
                    <div class="col-lg-3 col-md-6 widget-align">
                      <div class="widget darkblue-2 animated fadeInDown mt-0">
                        <div class="widget-content padding">
                          ...
                          <div class="text-box">
                            <p class="maindata">TOTAL DE <b>DOCUMENTOS</b></p>
                  ...
                  <div id="barchart_material" class="mt-3" style="width: auto; height: 500px;">
                      <input type="hidden" id="docs_creados" type="text" value="{{ $result }}">
                  </div>
                </div>
            </div>
        </div>
...
<script src="/js/reportes/docscreados_chart.js"></script>
